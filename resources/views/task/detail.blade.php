                ...
                <div class="post-wrap">
                    <article class="post clearfix">
                        ...
                        <div class="content-post">
                            <h3 class="title-post"> overdraft </h3>
                            ...
                            <div class="entry excerpt">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                                ...
                                <ul class="list-single">
                                    <li>Customer experience, which includes the impression the homepage and overall design style give the their satisfaction when they interact with the site and perform tasks. </li>
                                    ...
                                    <li>Best practices, such as ease of use, quality, availability and security – site managers must be compliant data laws requiring them to protect customer information and the integrity of customer accounts. </li>
                                </ul>
                ...
                <div class="sidebar">
                    <div class="widget widget-recent-news">
                        ...
                        <ul class="popular-news clearfix">
                            <li>
                                <div class="text">
                                    <h6><a href="blog-single.html#">Why Do I Need To Use Financial ?</a></h6>
                                    <p>January 11, 2017</p>
                                </div> </li>
                            <li>
                                <div class="text">
                                    <h6><a href="blog-single.html#"> Why your sales forecast is off</a></h6>
                                    <p>January 11, 2017</p>
                                </div> </li>
                            <li>
                                <div class="text">
                                    <h6><a href="blog-single.html#"> 6 tips to retain your top sales talent</a></h6>
                                    <p>January 11, 2017</p>
                                </div> </li>
                            <li>
                                <div class="text">
                                    <h6><a href="blog-single.html#"> What the martian can teach sales</a></h6>
                                    <p>January 11, 2017</p>
                                </div> </li>
                        </ul>
                        <!-- /.popular-news -->
